...
<div class="w3-half">
   ...
   <div class="w3-half">
      <form class="form1 w3-row-padding" id="textForm" action="inc/update_rtype.php" method="post">
         ...
         <p>
            <input type="text" id="rtype" name="rtype" class="rtype w3-input w3-round-xxlarge w3-padding-large w3-margin-top w3-margin-bottom" placeholder="Room Type..." required>
         </p>
         <p>
            <label class="w3-padding-large">Price</label>
         </p>
         <p>
            <input type="number" id="price" class="w3-input w3-round-xxlarge w3-padding-large w3-margin-top w3-margin-bottom" name="price" placeholder="price..." required>
         </p>
         <p>
            <label class="w3-padding-large">Description</label>
         </p>
         <p>
            <textarea name="desc" id="desc" class="w3-input w3-border w3-round-small w3-padding-large w3-margin-top w3-margin-bottom" placeholder="description..." required></textarea>
         </p>
